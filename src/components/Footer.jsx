        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shipping" className="text-sm hover:text-blue-400">
                  Shipping Information
                </Link>
              </li>
              <li>
                <Link to="/returns" className="text-sm hover:text-blue-400">
                  Returns & Exchanges
                </Link>
              </li>
              <li>
            ...
            <div className="mt-4">
              ...
              <form className="mt-2 flex">
                <input
                  ...
                  className="px-3 py-2 text-gray-700 bg-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-600 flex-grow"
                />
                <button
                  type="submit"
                  className="bg-blue-500 text-white px-4 py-2 rounded-r-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600"
                >
                  Subscribe
                </button>
              </form>
